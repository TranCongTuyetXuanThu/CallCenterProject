...
def upload_audio():
    ...
    if 'file' in request.files:
        ...
        if file.filename != '':
            ...
            #waveform_image =plot_waveform_async(wav_filepath)
            ...
            return render_template('demo.html', emotion=list_labels,waveform_image_path="waveform.png", audio = True, history=history, file=file.filename)
...
def predict_audio():
    ...
    # elif label=="neutral":
    #     label="Neutral" 
    return render_template('demo.html', emotions = list_labels, waveform_image="waveform_record.png", audio2 = True, histories=histories, file = 'recorded_audio.wav')
